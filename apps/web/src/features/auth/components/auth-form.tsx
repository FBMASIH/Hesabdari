...
const AUTH_SOCIAL =
  'auth-social-btn flex h-[42px] w-full items-center justify-center gap-2 rounded-full text-[13px] font-medium transition-all active:scale-[0.98] overflow-hidden';
      ...
      {mode === 'sign-in' && (
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              className="rounded-md text-[12px] font-semibold text-brand-deep hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-deep/25"
