...
const fa = {
  ...
  common: {
    ...
    revaluation: 'تسعیر ارز',
    syncRates: 'دریافت نرخ آنلاین',
    addManualRate: 'ثبت نرخ دستی',
    ...
    baseCurrencyEquivalent: 'معادل ارز پایه',
    changeBaseCurrency: 'تغییر ارز پیش‌فرض',
    baseCurrencyWarning: 'اسناد قبلی بدون تغییر باقی می‌مانند.',
    runRevaluation: 'اجرای تسعیر',
    reverseRevaluation: 'برگشت تسعیر',
    revaluationHistory: 'تاریخچه تسعیر',
    posted: 'ثبت‌شده',
    reversed: 'برگشت‌شده',
    gainLoss: 'سود/زیان',
